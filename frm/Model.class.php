 ...
 * @Version 2.0
 */
require_once FRM_PATH."/drivers/Mysql.class.php";
...
//		//4、自动填充
//		if (!empty($this->_auto)) {//如果配置了自动填充的规则 则进行填充
//			foreach ($this->_auto as $item => $tmp) {
//				//分别提取出规则的各个部分
//				list($field, $rule, $param, $type) = $tmp;//array("password", "md5", "", "function")
//				switch ($type) {
//					case "function" :
//						empty($param) && $param = $data[$field];
//						$data[$field] = $rule($param);
//				}
//			}
//		}
		//5、数据值过滤
