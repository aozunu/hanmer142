...
class Mysql {
	...
	public function __construct($charset = "utf8") {
		$this->link = mysqli_connect($GLOBALS['DB_HOST'], $GLOBALS['DB_USER'], $GLOBALS['DB_PASS']) or die("连接数据库失败");
		mysqli_select_db($this->link, $GLOBALS['DB_NAME']) or die("选择数据库失败");
		mysqli_set_charset($this->link, $GLOBALS['DB_CHARSET']);
	}
